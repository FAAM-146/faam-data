...
This document provides a description of the FAAM core data product, including a
summary of the processing that takes place and a standard which describes the
format of, and metadata associated with, the core data product.
